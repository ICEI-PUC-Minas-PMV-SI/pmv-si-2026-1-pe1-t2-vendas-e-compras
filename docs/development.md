...
| RF-08 | O sistema deve permitir que os usuários avaliem os produtos comprados.                                                            | Eduardo        | produto.html     |
...
| RF-12 | O sistema deve incluir um histórico de vendas feitas pelo vendedor.                                                               | Carlos Eduardo | perfil.html      |
